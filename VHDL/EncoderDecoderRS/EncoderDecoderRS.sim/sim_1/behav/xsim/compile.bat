...
REM
REM Generated by Vivado on Sat Mar 28 15:17:21 +0100 2026
...
echo "xvhdl --incr --relax -prj tb_rs_encoder_vhdl.prj"
call xvhdl  --incr --relax -prj tb_rs_encoder_vhdl.prj -log xvhdl.log
